										...
										?>
											<tr>
												...
												<td class="product-name"><a href="#"><?php echo $row['name']?></a>
													<ul  class="pro__prize">
														<li class="old__prize">MRP ₹<?php echo $row['mrp']?></li>
                                                ...
                                                <td class="product-remove"><a class="fr__btn" href="javascript:void(0)" style=" height: 45px; font-size: 18px; line-height: 40px;" onclick="manage_cart('<?php echo $row['pid']?>','add')">Add to cart</a></td>
