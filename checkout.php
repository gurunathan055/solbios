										...
										<div class="accordion__body">
											<div class="paymentinfo">
												<div class="single-method">
													...
													&nbsp;&nbsp;<input type="radio" name="payment_type" value="payu" required/> Online Payment(Credit Card/Debit Card/UPI) 
												</div>
												<div class="single-method">
