                                    ...
                                    <tbody>
										...
										if(isset($_SESSION['cart'])){
											...
											<tr>
												...
												<br/><a href="javascript:void(0)" onclick="manage_cart('<?php echo $key?>','update')"><button type="button" class="btn btn-info" style="margin-top: 8px; font-size: 12px;">Update</button></a>
												</td>
